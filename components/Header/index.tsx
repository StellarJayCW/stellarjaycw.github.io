      ...
      <Navbar>
        ...
        <NavbarGroup data-desktop-navbar>
          ...
          <Tooltip content='Github'>
            <NavbarItem href='https://github.com/StellarJayCW' target='_blank'>
              <GithubLogo />
            </NavbarItem>
          </Tooltip>
          <Tooltip content='Twitter'>
            <NavbarItem href='https://twitter.com/JCWcrypto' target='_blank'>
              <TwitterLogo />
            </NavbarItem>
          </Tooltip>
          <Tooltip content='Linkedin'>
            <NavbarItem
              href='https://www.linkedin.com/in/joshua-westover-379686116/'
              target='_blank'
            >
              <LinkedinLogo />
            </NavbarItem>
